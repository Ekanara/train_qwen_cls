...
if __name__ =='__main__':
    ...
    training_args = TrainingArguments(
        output_dir="Qwenv2.5_MRPC_results_f1(pre)",
        eval_strategy="epoch",
    ...
    best_training_args = TrainingArguments(
        output_dir="Qwenv2.5_MRPC_results_f1",
        eval_strategy="epoch",
        save_strategy="epoch",
        logging_strategy="epoch",
        #lr_scheduler_type="cosine",
    ...
    trainer.train()
    trainer.model.push_to_hub("Ekanari/Qwenv2.5_MRPC_results_f1")
    tokenizer.push_to_hub("Ekanari/Qwenv2.5_MRPC_results_f1")
